...
//     setLoader(true)
//     try{
//         const res=await axios.get(`https://blogserver-bskv.onrender.com/api/posts/post/`+param.id)
...
//     }
//  try{
//  const res=await axios.put(`https://blogserver-bskv.onrender.com/api/posts/post/`+param.id,newPost)
...
const EditPost = () => {
  ...
  const handleCreatePost = async (e) => {
    ...
    if (file) {
      ...
      try {
        await axios.post(
          `h${import.meta.env.VITE_URL}/api/upload`,
          data
        );
