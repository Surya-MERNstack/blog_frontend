...
const PostDetails = () => {
    ...
    const postDelete=async()=>{
      try{
        await axios.delete(`https://blogserver-bskv.onrender.com/api/posts/post/`+postId)
        .then((res)=>{
          navigate("/")
        })
    ...
    const deleteComment=async(id)=>{
        try{
          await axios.delete(`https://blogserver-bskv.onrender.com/api/comments/comment/`+id)
          .then((res)=>{
    ...
    const fetchComments=async()=>{
        setLoader(true)
        try{
            const res=await axios.get(`https://blogserver-bskv.onrender.com/api/comments/post/`+id)
    ...
    const fetchPostData=async()=>{
        setLoader(true)
        try{
            const res=await axios.get(`https://blogserver-bskv.onrender.com/api/posts/post/`+id)
           // console.log(res.data)
      ...
      const handleComment=()=>{
           axios.post(`https://blogserver-bskv.onrender.com/api/comments/create`,{comment:comment,author:user.username,postId:id,userId:user._id})
           .then((res)=>{
             setComment("")
             fetchComments()
  ...
  return (
    <>
        ...
        {!loader?<img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.dfstudio.com%2Fdigital-image-size-and-resolution-what-do-you-need-to-know%2F&psig=AOvVaw3lfZCtKys0CEoAIll_Kcur&ust=1702189005269000&source=images&cd=vfe&ved=0CBIQjRxqFwoTCKC1vu7agYMDFQAAAAAdAAAAABAE" alt="image" className='w-full mx-auto mt-4'/>:
